"use strict";
(self["webpackChunkgateway"] = self["webpackChunkgateway"] || []).push([["default-node_modules_angular_router_fesm2015_router_mjs"],{
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ 4125);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ 2070);
...
class UrlParser {
  ...
  parseSegment() {
    ...
    if (path === '' && this.peekStartsWith(';')) {
      ...
      , NG_DEV_MODE$7 && `Empty path url segment cannot have parameters: '${this.remaining}'.`);
    }
  ...
  parseParens(allowPrimary) {
    ...
    while (!this.consumeOptional(')') && this.remaining.length > 0) {
      ...
      if (next !== '/' && next !== ')' && next !== ';') {
        ...
        , NG_DEV_MODE$7 && `Cannot parse url '${this.url}'`);
      }
...
class Navigation {
  constructor(isAbsolute, numberOfDoubleDots, commands) {
    ...
    if (isAbsolute && commands.length > 0 && isMatrixParams(commands[0])) {
      ...
      , NG_DEV_MODE$6 && 'Root segment cannot have matrix parameters');
    }
    ...
    if (cmdWithOutlet && cmdWithOutlet !== last(commands)) {
      ...
      , NG_DEV_MODE$6 && '{outlets:{}} has to be the last command');
    }
  }
...
function createPositionApplyingDoubleDots(group, index, numberOfDoubleDots) {
  ...
  while (dd > ci) {
    ...
    if (!g) {
      ...
      , NG_DEV_MODE$6 && 'Invalid number of \'../\'');
    }
...
class ActivatedRoute {
  ...
  get paramMap() {
    if (!this._paramMap) {
      this._paramMap = this.params.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(p => convertToParamMap(p)));
    }
  ...
  get queryParamMap() {
    if (!this._queryParamMap) {
      this._queryParamMap = this.queryParams.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(p => convertToParamMap(p)));
    }
...
class RouterOutlet {
  ...
  get component() {
    ...
    , NG_DEV_MODE$5 && 'Outlet is not activated');
  ...
  activateWith(activatedRoute, resolverOrInjector) {
    if (this.isActivated) {
      ...
      , NG_DEV_MODE$5 && 'Cannot activate an already activated outlet');
    }
...
const activateRoutes = (rootContexts, routeReuseStrategy, forwardEvent) => (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(t => {
    ...
    if (future === curr) {
      ...
      if (future.component) {
        ...
        if (this.routeReuseStrategy.shouldAttach(future.snapshot)) {
          ...
          const cmpFactoryResolver = (_a = injector === null || injector === void 0 ? void 0 : injector.get(_angular_core__WEBPACK_IMPORTED_MODULE_0__.ComponentFactoryResolver)) !== null && _a !== void 0 ? _a : null;
          context.attachRef = null;
...
function prioritizedGuardValue() {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(obs => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.combineLatest)(obs.map(o => o.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.startWith)(INITIAL_VALUE)))).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(results => {
      ...
      return true;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(item => item !== INITIAL_VALUE), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.take)(1));
  });
}
/**
 * @license
...
function checkGuards(moduleInjector, forwardEvent) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(t => {
    const {
      targetSnapshot,
      currentSnapshot,
      guards: {
    ...
    if (canDeactivateChecks.length === 0 && canActivateChecks.length === 0) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(Object.assign(Object.assign({}, t), {
        guardsResult: true
      }));
    }

    return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(canDeactivate => {
      return canDeactivate && isBoolean(canDeactivate) ? runCanActivateChecks(targetSnapshot, canActivateChecks, moduleInjector, forwardEvent) : (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(canDeactivate);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(guardsResult => Object.assign(Object.assign({}, t), {
      guardsResult
    })));
  });
}
...
function runCanDeactivateChecks(checks, futureRSS, currRSS, moduleInjector) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(check => runCanDeactivate(check.component, check.route, currRSS, futureRSS, moduleInjector)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.first)(result => {
    return result !== true;
  }, true));
}

function runCanActivateChecks(futureSnapshot, checks, moduleInjector, forwardEvent) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.concatMap)(check => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.concat)(fireChildActivationStart(check.route.parent, forwardEvent), fireActivationStart(check.route, forwardEvent), runCanActivateChild(futureSnapshot, check.path, moduleInjector), runCanActivate(futureSnapshot, check.route, moduleInjector));
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.first)(result => {
    return result !== true;
  }, true));
}
/**
...
function runCanActivate(futureRSS, futureARS, moduleInjector) {
  ...
  const canActivateObservables = canActivate.map(c => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.defer)(() => {
      ...
      return wrapIntoObservable(guardVal).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.first)());
    });
  });
...
function redirectIfUrlTree(urlSerializer) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.pipe)((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(result => {
    if (!isUrlTree(result)) return;
    throw redirectingNavigationError(urlSerializer, result);
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(result => result === true));
}
...
function matchWithChecks(segmentGroup, route, segments, injector, urlSerializer) {
  ...
  return runCanMatchGuards(injector, route, segments, urlSerializer).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(v => v === true ? result : Object.assign({}, noMatch$1)));
}
...
function namedOutletsRedirect(redirectTo) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(new _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵRuntimeError"](4000
  /* RuntimeErrorCode.NAMED_OUTLET_REDIRECT */
  , NG_DEV_MODE$4 && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}

function canLoadFails(route) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(navigationCancelingError(NG_DEV_MODE$4 && `Cannot load children because the guard of the route "path: '${route.path}'" returned false`, 3
...
class ApplyRedirects {
  ...
  apply() {
    ...
    const urlTrees$ = expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(rootSegmentGroup => {
      return this.createUrlTree(squashSegmentGroup(rootSegmentGroup), this.urlTree.queryParams, this.urlTree.fragment);
    }));
    return urlTrees$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => {
  ...
  match(tree) {
    ...
    const mapped$ = expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(rootSegmentGroup => {
      return this.createUrlTree(squashSegmentGroup(rootSegmentGroup), tree.queryParams, tree.fragment);
    }));
    return mapped$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => {
      if (e instanceof NoMatch$1) {
        throw this.noMatchError(e);
      }
  ...
  noMatchError(e) {
    ...
    , NG_DEV_MODE$4 && `Cannot match any routes. URL Segment: '${e.segmentGroup}'`);
  }
  ...
  expandSegmentGroup(injector, routes, segmentGroup, outlet) {
    if (segmentGroup.segments.length === 0 && segmentGroup.hasChildren()) {
      return this.expandChildren(injector, routes, segmentGroup).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(children => new UrlSegmentGroup([], children)));
    }
  ...
  expandChildren(injector, routes, segmentGroup) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(childOutlets).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.concatMap)(childOutlet => {
      ...
      return this.expandSegmentGroup(injector, sortedRoutes, child, childOutlet).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(s => ({
        segment: s,
        outlet: childOutlet
      })));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.scan)((children, expandedChild) => {
      children[expandedChild.outlet] = expandedChild.segment;
      return children;
    }, {}), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.last)());
  }

  expandSegment(injector, segmentGroup, routes, segments, outlet, allowRedirects) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(routes).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.concatMap)(r => {
      const expanded$ = this.expandSegmentAgainstRoute(injector, segmentGroup, routes, r, segments, outlet, allowRedirects);
      return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => {
        if (e instanceof NoMatch$1) {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.first)(s => !!s), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)((e, _) => {
  ...
  expandWildCardWithParamsAgainstRouteUsingRedirect(injector, routes, route, outlet) {
    ...
    return this.lineralizeSegments(route, newTree).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(newSegments => {
  ...
  matchSegmentAgainstRoute(injector, rawSegmentGroup, route, segments, outlet) {
    if (route.path === '**') {
      ...
      if (route.loadChildren) {
        ...
        return loaded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(cfg => {
    ...
    return matchWithChecks(rawSegmentGroup, route, segments, injector, this.urlSerializer).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(({
      matched,
      consumedSegments,
      remainingSegments
    }) => {
      ...
      return childConfig$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(routerConfig => {
        var _a;
        ...
        if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
          ...
          return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(children => new UrlSegmentGroup(consumedSegments, children)));
        }
        ...
        return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(cs => new UrlSegmentGroup(consumedSegments.concat(cs.segments), cs.children)));
      }));
    }));
  }
  ...
  getChildConfig(injector, route, segments) {
    ...
    if (route.loadChildren) {
      ...
      return runCanLoadGuards(injector, route, segments, this.urlSerializer).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(shouldLoadResult => {
        if (shouldLoadResult) {
          return this.configLoader.loadChildren(injector, route).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(cfg => {
            route._loadedRoutes = cfg.routes;
            route._loadedInjector = cfg.injector;
          }));
        }
  ...
  findPosParam(redirectTo, redirectToUrlSegment, posParams) {
    ...
    , NG_DEV_MODE$4 && `Cannot redirect to '${redirectTo}'. Cannot find '${redirectToUrlSegment.path}'.`);
    return pos;
  }
...
function applyRedirects(environmentInjector, configLoader, urlSerializer, config) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(t => applyRedirects$1(environmentInjector, configLoader, urlSerializer, t.extractedUrl, config).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(urlAfterRedirects => Object.assign(Object.assign({}, t), {
    urlAfterRedirects
  }))));
}
/**
...
function recognize$1(injector, rootComponentType, config, urlTree, url, urlSerializer, paramsInheritanceStrategy = 'emptyOnly', relativeLinkResolution = 'legacy') {
  return new Recognizer(injector, rootComponentType, config, urlTree, url, paramsInheritanceStrategy, relativeLinkResolution, urlSerializer).recognize().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(result => {
    if (result === null) {
...
class Recognizer {
  ...
  recognize() {
    ...
    return this.processSegmentGroup(this.injector, this.config, rootSegmentGroup, PRIMARY_OUTLET).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(children => {
      if (children === null) {
        return null;
  ...
  processChildren(injector, config, segmentGroup) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(Object.keys(segmentGroup.children)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.concatMap)(childOutlet => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.scan)((children, outletChildren) => {
      if (!children || !outletChildren) return null;
      children.push(...outletChildren);
      return children;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.takeWhile)(children => children !== null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.defaultIfEmpty)(null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.last)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(children => {
  ...
  processSegment(injector, routes, segmentGroup, segments, outlet) {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.first)(x => !!x), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => {
      if (e instanceof rxjs__WEBPACK_IMPORTED_MODULE_1__.EmptyError) {
        if (noLeftoversInUrl(segmentGroup, segments, outlet)) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)([]);
        }
  ...
  processSegmentAgainstRoute(injector, route, rawSegment, segments, outlet) {
    ...
    if (route.path === '**') {
      ...
      matchResult = matchWithChecks(rawSegment, route, segments, injector, this.urlSerializer).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(({
        matched,
        consumedSegments,
        remainingSegments,
        parameters
        ...
        const snapshot = new ActivatedRouteSnapshot(consumedSegments, parameters, Object.freeze(Object.assign({}, this.urlTree.queryParams)), this.urlTree.fragment, getData(route), getOutlet(route), (_b = (_a = route.component) !== null && _a !== void 0 ? _a : route._loadedComponent) !== null && _b !== void 0 ? _b : null, route, getSourceSegmentGroup(rawSegment), pathIndexShift, getResolve(route), NG_DEV_MODE$3 ? getCorrectedPathIndexShift(rawSegment) + consumedSegments.length : pathIndexShift);
        return {
          snapshot,
          consumedSegments,
          remainingSegments
    ...
    return matchResult.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(result => {
      var _a, _b;
      ...
      if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
        return this.processChildren(childInjector, childConfig, segmentGroup).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(children => {
          if (children === null) {
            return null;
          }
      ...
      return this.processSegment(childInjector, childConfig, segmentGroup, slicedSegments, matchedOnOutlet ? PRIMARY_OUTLET : outlet).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(children => {
        if (children === null) {
          return null;
        }
...
function checkOutletNameUniqueness(nodes) {
  ...
  nodes.forEach(n => {
    ...
    if (routeWithSameOutletName) {
      ...
      , NG_DEV_MODE$3 && `Two segments cannot have the same outlet name: '${p}' and '${c}'.`);
    }
...
function recognize(injector, rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(t => recognize$1(injector, rootComponentType, config, t.urlAfterRedirects, serializer.serialize(t.urlAfterRedirects), serializer, paramsInheritanceStrategy, relativeLinkResolution).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(targetSnapshot => Object.assign(Object.assign({}, t), {
    targetSnapshot
  }))));
}
/**
...
function resolveData(paramsInheritanceStrategy, moduleInjector) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(t => {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(canActivateChecks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.concatMap)(check => runResolve(check.route, targetSnapshot, paramsInheritanceStrategy, moduleInjector)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(() => canActivateChecksResolved++), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(_ => canActivateChecksResolved === canActivateChecks.length ? (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(t) : rxjs__WEBPACK_IMPORTED_MODULE_1__.EMPTY));
  });
}
...
function runResolve(futureARS, futureRSS, paramsInheritanceStrategy, moduleInjector) {
  ...
  return resolveNode(resolve, futureARS, futureRSS, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(resolvedData => {
...
function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
  ...
  const data = {};
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(keys).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(key => getResolver(resolve[key], futureARS, futureRSS, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.first)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(value => {
    data[key] = value;
  }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mapTo)(data), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => e instanceof rxjs__WEBPACK_IMPORTED_MODULE_1__.EmptyError ? rxjs__WEBPACK_IMPORTED_MODULE_1__.EMPTY : (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(e)));
}
...
function switchTap(next) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(v => {
    const nextResult = next(v);

    if (nextResult) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(nextResult).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(() => v));
    }
...
class RouterConfigLoader {
  ...
  loadComponent(route) {
    ...
    const loadRunner = wrapIntoObservable(route.loadComponent()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(component => {
      var _a;
    ...
    const loader = new rxjs__WEBPACK_IMPORTED_MODULE_1__.ConnectableObservable(loadRunner, () => new rxjs__WEBPACK_IMPORTED_MODULE_1__.Subject()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.refCount)());
  ...
  loadChildren(parentInjector, route) {
    ...
    const loadRunner = moduleFactoryOrRoutes$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(factoryOrRoutes => {
      if (this.onLoadEndListener) {
        this.onLoadEndListener(route);
  ...
  loadModuleFactoryOrRoutes(loadChildren) {
    return wrapIntoObservable(loadChildren()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(t => {
...
class Router {
  ...
  setupNavigations(transitions) {
    ...
    return transitions.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(t => t.id !== 0), // Extract URL
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(t => Object.assign(Object.assign({}, t), {
      extractedUrl: this.urlHandlingStrategy.extract(t.rawUrl)
    })), // Using switchMap so we cancel executing navigations when a new one comes in
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(overallTransitionState => {
      let completed = false;
      let errored = false;
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(overallTransitionState).pipe( // Store the Navigation object
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(t => {
      ...
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(t => {
        ...
        if (processCurrentUrl) {
          ...
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(t).pipe( // Fire NavigationStart event
          (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(t => {
      ...
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(t => {
        overallTransitionState = Object.assign(Object.assign({}, t), {
          guards: getAllRouteGuards(t.targetSnapshot, t.currentSnapshot, this.rootContexts)
        });
        return overallTransitionState;
      }), checkGuards(this.ngModule.injector, evt => this.triggerEvent(evt)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(t => {
      ...
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(t => {
        if (!t.guardsResult) {
      ...
      switchTap(t => {
        if (t.guards.canActivateChecks.length) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(t).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(t => {
            const resolveStart = new ResolveStart(t.id, this.serializeUrl(t.extractedUrl), this.serializeUrl(t.urlAfterRedirects), t.targetSnapshot);
            this.triggerEvent(resolveStart);
          }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(t => {
            let dataResolved = false;
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(t).pipe(resolveData(this.paramsInheritanceStrategy, this.ngModule.injector), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)({
      ...
      switchTap(t => {
        const loadComponents = route => {
          ...
          if (((_a = route.routeConfig) === null || _a === void 0 ? void 0 : _a.loadComponent) && !route.routeConfig._loadedComponent) {
            loaders.push(this.configLoader.loadComponent(route.routeConfig).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(loadedComponent => {
              route.component = loadedComponent;
            }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(() => void 0)));
          }
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.combineLatest)(loadComponents(t.targetSnapshot.root)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.defaultIfEmpty)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.take)(1));
      }), switchTap(() => this.afterPreactivation()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(t => {
      ...
      }), activateRoutes(this.rootContexts, this.routeReuseStrategy, evt => this.triggerEvent(evt)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)({
        next() {
          completed = true;
        },
      ...
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => {
        var _a;
...
RouterLinkWithHref.ɵfac = function RouterLinkWithHref_Factory(t) {
  return new (t || RouterLinkWithHref)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](Router), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_3__.LocationStrategy));
};
...
class RouterLinkActive {
  ...
  ngAfterContentInit() {
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(this.links.changes, this.linksWithHrefs.changes, (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(null)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeAll)()).subscribe(_ => {
      this.update();
  ...
  subscribeToEachLinkOnChanges() {
    ...
    this.linkInputChangesSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(allLinkChanges).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeAll)()).subscribe(link => {
...
class PreloadAllModules {
  preload(route, fn) {
    return fn().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(null)));
  }
...
class RouterPreloader {
  ...
  setUpPreloading() {
    this.subscription = this.router.events.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(e => e instanceof NavigationEnd), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.concatMap)(() => this.preload())).subscribe(() => {});
  }
  ...
  processRoutes(injector, routes) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(res).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeAll)());
  }
  ...
  preloadConfig(injector, route) {
    return this.preloadingStrategy.preload(route, () => {
      ...
      const recursiveLoadChildren$ = loadedChildren$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeMap)(config => {
        var _a;
      ...
      if (route.loadComponent && !route._loadedComponent) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)([recursiveLoadChildren$, loadComponent$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.mergeAll)());
      } else {
...
const ROUTER_PROVIDERS = [_angular_common__WEBPACK_IMPORTED_MODULE_3__.Location, {
  ...
  deps: [UrlSerializer, ChildrenOutletContexts, _angular_common__WEBPACK_IMPORTED_MODULE_3__.Location, _angular_core__WEBPACK_IMPORTED_MODULE_0__.Injector, _angular_core__WEBPACK_IMPORTED_MODULE_0__.Compiler, ROUTES, TitleStrategy, ROUTER_CONFIGURATION, [UrlHandlingStrategy, new _angular_core__WEBPACK_IMPORTED_MODULE_0__.Optional()], [RouteReuseStrategy, new _angular_core__WEBPACK_IMPORTED_MODULE_0__.Optional()]]
...
class RouterModule {
  ...
  static forRoot(routes, config) {
    return {
      ngModule: RouterModule,
      providers: [ROUTER_PROVIDERS, NG_DEV_MODE ? (config === null || config === void 0 ? void 0 : config.enableTracing) ? provideTracing() : [] : [], provideRoutes(routes), {
      ...
      }, (config === null || config === void 0 ? void 0 : config.useHash) ? provideHashLocationStrategy() : providePathLocationStrategy(), provideRouterScroller(), (config === null || config === void 0 ? void 0 : config.preloadingStrategy) ? providePreloading(config.preloadingStrategy) : [], {
...
function provideRouterScroller() {
  return {
    ...
    useFactory: () => {
      ...
      const viewportScroller = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_3__.ViewportScroller);
...
function getBootstrapListener() {
  ...
  return bootstrappedComponentRef => {
    ...
    (_a = injector.get(ROUTER_PRELOADER, null, _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectFlags.Optional)) === null || _a === void 0 ? void 0 : _a.setUpPreloading();
    (_b = injector.get(ROUTER_SCROLLER, null, _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectFlags.Optional)) === null || _b === void 0 ? void 0 : _b.init();
...
function provideEnabledBlockingInitialNavigation() {
  return [{
    ...
    useFactory: injector => {
      const locationInitialized = injector.get(_angular_common__WEBPACK_IMPORTED_MODULE_3__.LOCATION_INITIALIZED, Promise.resolve(null));
      ...
      function afterNextNavigation(action) {
        const router = injector.get(Router);
        router.events.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(e => e instanceof NavigationEnd || e instanceof NavigationCancel || e instanceof NavigationError), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(e => {
        ...
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(result => result !== null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.take)(1)).subscribe(() => {
          action();
        });
      }
        ...
        return locationInitialized.then(() => {
          return new Promise(resolve => {
            ...
            router.afterPreactivation = () => {
              ...
              if (!initNavigation) {
                return bootstrapDone.closed ? (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(void 0) : bootstrapDone; // subsequent navigations should not be delayed
              } else {
                return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(void 0);
              }
            };
...
//# sourceMappingURL=default-node_modules_angular_router_fesm2015_router_mjs.js.map