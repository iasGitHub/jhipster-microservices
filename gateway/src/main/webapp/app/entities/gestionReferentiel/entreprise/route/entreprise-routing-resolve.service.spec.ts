...
describe('Entreprise routing resolve service', () => {
  ...
  let resultEntreprise: IEntreprise | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEntreprise).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEntreprise>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
