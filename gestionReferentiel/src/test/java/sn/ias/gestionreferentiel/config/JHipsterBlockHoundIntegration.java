package sn.ias.gestionreferentiel.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("sn.ias.gestionreferentiel.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("sn.ias.gestionreferentiel.security.DomainUserDetailsService", "createSpringSecurityUser");
